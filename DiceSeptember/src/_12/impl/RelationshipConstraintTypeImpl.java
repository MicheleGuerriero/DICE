 ...
 * <ul>
 *   <li>{@link _12.impl.RelationshipConstraintTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link _12.impl.RelationshipConstraintTypeImpl#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationshipConstraintTypeImpl extends MinimalEObjectImpl.Container implements RelationshipConstraintType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.RELATIONSHIP_CONSTRAINT_TYPE;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _12Package.RELATIONSHIP_CONSTRAINT_TYPE__ANY);
		}
		return any;
	}
	...
	public void setConstraintType(String newConstraintType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.RELATIONSHIP_CONSTRAINT_TYPE__CONSTRAINT_TYPE, oldConstraintType, constraintType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.RELATIONSHIP_CONSTRAINT_TYPE__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.RELATIONSHIP_CONSTRAINT_TYPE__CONSTRAINT_TYPE:
