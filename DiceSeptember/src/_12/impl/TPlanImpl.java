 ...
 * <ul>
 *   <li>{@link _12.impl.TPlanImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getInputParameters <em>Input Parameters</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getOutputParameters <em>Output Parameters</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getPlanModel <em>Plan Model</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getPlanModelReference <em>Plan Model Reference</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getId <em>Id</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getName <em>Name</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getPlanLanguage <em>Plan Language</em>}</li>
 *   <li>{@link _12.impl.TPlanImpl#getPlanType <em>Plan Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPlanImpl extends TExtensibleElementsImpl implements TPlan {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TPLAN;
	}
	...
	public NotificationChain basicSetPrecondition(TCondition newPrecondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PRECONDITION, oldPrecondition, newPrecondition);
	...
	public void setPrecondition(TCondition newPrecondition) {
		if (newPrecondition != precondition) {
			...
			if (precondition != null)
				msgs = ((InternalEObject)precondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PRECONDITION, null, msgs);
			if (newPrecondition != null)
				msgs = ((InternalEObject)newPrecondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PRECONDITION, null, msgs);
			msgs = basicSetPrecondition(newPrecondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PRECONDITION, newPrecondition, newPrecondition));
	}
	...
	public NotificationChain basicSetInputParameters(InputParametersType1 newInputParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__INPUT_PARAMETERS, oldInputParameters, newInputParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInputParameters(InputParametersType1 newInputParameters) {
		if (newInputParameters != inputParameters) {
			...
			if (inputParameters != null)
				msgs = ((InternalEObject)inputParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__INPUT_PARAMETERS, null, msgs);
			if (newInputParameters != null)
				msgs = ((InternalEObject)newInputParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__INPUT_PARAMETERS, null, msgs);
			msgs = basicSetInputParameters(newInputParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__INPUT_PARAMETERS, newInputParameters, newInputParameters));
	}
	...
	public NotificationChain basicSetOutputParameters(OutputParametersType1 newOutputParameters, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__OUTPUT_PARAMETERS, oldOutputParameters, newOutputParameters);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOutputParameters(OutputParametersType1 newOutputParameters) {
		if (newOutputParameters != outputParameters) {
			...
			if (outputParameters != null)
				msgs = ((InternalEObject)outputParameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__OUTPUT_PARAMETERS, null, msgs);
			if (newOutputParameters != null)
				msgs = ((InternalEObject)newOutputParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__OUTPUT_PARAMETERS, null, msgs);
			msgs = basicSetOutputParameters(newOutputParameters, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__OUTPUT_PARAMETERS, newOutputParameters, newOutputParameters));
	}
	...
	public NotificationChain basicSetPlanModel(PlanModelType newPlanModel, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_MODEL, oldPlanModel, newPlanModel);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlanModel(PlanModelType newPlanModel) {
		if (newPlanModel != planModel) {
			NotificationChain msgs = null;
			if (planModel != null)
				msgs = ((InternalEObject)planModel).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PLAN_MODEL, null, msgs);
			if (newPlanModel != null)
				msgs = ((InternalEObject)newPlanModel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PLAN_MODEL, null, msgs);
			msgs = basicSetPlanModel(newPlanModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_MODEL, newPlanModel, newPlanModel));
	}
	...
	public NotificationChain basicSetPlanModelReference(PlanModelReferenceType newPlanModelReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_MODEL_REFERENCE, oldPlanModelReference, newPlanModelReference);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlanModelReference(PlanModelReferenceType newPlanModelReference) {
		if (newPlanModelReference != planModelReference) {
			...
			if (planModelReference != null)
				msgs = ((InternalEObject)planModelReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PLAN_MODEL_REFERENCE, null, msgs);
			if (newPlanModelReference != null)
				msgs = ((InternalEObject)newPlanModelReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPLAN__PLAN_MODEL_REFERENCE, null, msgs);
			msgs = basicSetPlanModelReference(newPlanModelReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_MODEL_REFERENCE, newPlanModelReference, newPlanModelReference));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__NAME, oldName, name));
	}
	...
	public void setPlanLanguage(String newPlanLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_LANGUAGE, oldPlanLanguage, planLanguage));
	}
	...
	public void setPlanType(String newPlanType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPLAN__PLAN_TYPE, oldPlanType, planType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TPLAN__PRECONDITION:
				return basicSetPrecondition(null, msgs);
			case _12Package.TPLAN__INPUT_PARAMETERS:
				return basicSetInputParameters(null, msgs);
			case _12Package.TPLAN__OUTPUT_PARAMETERS:
				return basicSetOutputParameters(null, msgs);
			case _12Package.TPLAN__PLAN_MODEL:
				return basicSetPlanModel(null, msgs);
			case _12Package.TPLAN__PLAN_MODEL_REFERENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TPLAN__ID:
				return getId();
			case _12Package.TPLAN__NAME:
				return getName();
			case _12Package.TPLAN__PLAN_LANGUAGE:
				return getPlanLanguage();
			case _12Package.TPLAN__PLAN_TYPE:
				return getPlanType();
		}
