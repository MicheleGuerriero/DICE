 ...
 * <ul>
 *   <li>{@link _12.impl.TRequirementTypeImpl#getRequiredCapabilityType <em>Required Capability Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TRequirementTypeImpl extends TEntityTypeImpl implements TRequirementType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TREQUIREMENT_TYPE;
	}
	...
	public void setRequiredCapabilityType(QName newRequiredCapabilityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_TYPE__REQUIRED_CAPABILITY_TYPE, oldRequiredCapabilityType, requiredCapabilityType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TREQUIREMENT_TYPE__REQUIRED_CAPABILITY_TYPE:
