 ...
 * <ul>
 *   <li>{@link _12.impl.TImplementationArtifactImpl#getArtifactRef <em>Artifact Ref</em>}</li>
 *   <li>{@link _12.impl.TImplementationArtifactImpl#getArtifactType <em>Artifact Type</em>}</li>
 *   <li>{@link _12.impl.TImplementationArtifactImpl#getInterfaceName <em>Interface Name</em>}</li>
 *   <li>{@link _12.impl.TImplementationArtifactImpl#getOperationName <em>Operation Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TImplementationArtifactImpl extends TExtensibleElementsImpl implements TImplementationArtifact {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TIMPLEMENTATION_ARTIFACT;
	}
	...
	public void setArtifactRef(QName newArtifactRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TIMPLEMENTATION_ARTIFACT__ARTIFACT_REF, oldArtifactRef, artifactRef));
	}
	...
	public void setArtifactType(QName newArtifactType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TIMPLEMENTATION_ARTIFACT__ARTIFACT_TYPE, oldArtifactType, artifactType));
	}
	...
	public void setInterfaceName(String newInterfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TIMPLEMENTATION_ARTIFACT__INTERFACE_NAME, oldInterfaceName, interfaceName));
	}
	...
	public void setOperationName(String newOperationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TIMPLEMENTATION_ARTIFACT__OPERATION_NAME, oldOperationName, operationName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TIMPLEMENTATION_ARTIFACT__ARTIFACT_REF:
				return getArtifactRef();
			case _12Package.TIMPLEMENTATION_ARTIFACT__ARTIFACT_TYPE:
				return getArtifactType();
			case _12Package.TIMPLEMENTATION_ARTIFACT__INTERFACE_NAME:
				return getInterfaceName();
			case _12Package.TIMPLEMENTATION_ARTIFACT__OPERATION_NAME:
