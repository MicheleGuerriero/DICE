 ...
 * <ul>
 *   <li>{@link _12.impl.TNodeTypeImpl#getRequirementDefinitions <em>Requirement Definitions</em>}</li>
 *   <li>{@link _12.impl.TNodeTypeImpl#getCapabilityDefinitions <em>Capability Definitions</em>}</li>
 *   <li>{@link _12.impl.TNodeTypeImpl#getInstanceStates <em>Instance States</em>}</li>
 *   <li>{@link _12.impl.TNodeTypeImpl#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TNodeTypeImpl extends TEntityTypeImpl implements TNodeType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TNODE_TYPE;
	}
	...
	public NotificationChain basicSetRequirementDefinitions(RequirementDefinitionsType newRequirementDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__REQUIREMENT_DEFINITIONS, oldRequirementDefinitions, newRequirementDefinitions);
	...
	public void setRequirementDefinitions(RequirementDefinitionsType newRequirementDefinitions) {
		if (newRequirementDefinitions != requirementDefinitions) {
			...
			if (requirementDefinitions != null)
				msgs = ((InternalEObject)requirementDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__REQUIREMENT_DEFINITIONS, null, msgs);
			if (newRequirementDefinitions != null)
				msgs = ((InternalEObject)newRequirementDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__REQUIREMENT_DEFINITIONS, null, msgs);
			msgs = basicSetRequirementDefinitions(newRequirementDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__REQUIREMENT_DEFINITIONS, newRequirementDefinitions, newRequirementDefinitions));
	}
	...
	public NotificationChain basicSetCapabilityDefinitions(CapabilityDefinitionsType newCapabilityDefinitions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__CAPABILITY_DEFINITIONS, oldCapabilityDefinitions, newCapabilityDefinitions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCapabilityDefinitions(CapabilityDefinitionsType newCapabilityDefinitions) {
		if (newCapabilityDefinitions != capabilityDefinitions) {
			...
			if (capabilityDefinitions != null)
				msgs = ((InternalEObject)capabilityDefinitions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__CAPABILITY_DEFINITIONS, null, msgs);
			if (newCapabilityDefinitions != null)
				msgs = ((InternalEObject)newCapabilityDefinitions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__CAPABILITY_DEFINITIONS, null, msgs);
			msgs = basicSetCapabilityDefinitions(newCapabilityDefinitions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__CAPABILITY_DEFINITIONS, newCapabilityDefinitions, newCapabilityDefinitions));
	}
	...
	public NotificationChain basicSetInstanceStates(TTopologyElementInstanceStates newInstanceStates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__INSTANCE_STATES, oldInstanceStates, newInstanceStates);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInstanceStates(TTopologyElementInstanceStates newInstanceStates) {
		if (newInstanceStates != instanceStates) {
			...
			if (instanceStates != null)
				msgs = ((InternalEObject)instanceStates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__INSTANCE_STATES, null, msgs);
			if (newInstanceStates != null)
				msgs = ((InternalEObject)newInstanceStates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__INSTANCE_STATES, null, msgs);
			msgs = basicSetInstanceStates(newInstanceStates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__INSTANCE_STATES, newInstanceStates, newInstanceStates));
	}
	...
	public NotificationChain basicSetInterfaces(InterfacesType newInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__INTERFACES, oldInterfaces, newInterfaces);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInterfaces(InterfacesType newInterfaces) {
		if (newInterfaces != interfaces) {
			NotificationChain msgs = null;
			if (interfaces != null)
				msgs = ((InternalEObject)interfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__INTERFACES, null, msgs);
			if (newInterfaces != null)
				msgs = ((InternalEObject)newInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TNODE_TYPE__INTERFACES, null, msgs);
			msgs = basicSetInterfaces(newInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TYPE__INTERFACES, newInterfaces, newInterfaces));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TNODE_TYPE__REQUIREMENT_DEFINITIONS:
				return basicSetRequirementDefinitions(null, msgs);
			case _12Package.TNODE_TYPE__CAPABILITY_DEFINITIONS:
				return basicSetCapabilityDefinitions(null, msgs);
			case _12Package.TNODE_TYPE__INSTANCE_STATES:
				return basicSetInstanceStates(null, msgs);
			case _12Package.TNODE_TYPE__INTERFACES:
