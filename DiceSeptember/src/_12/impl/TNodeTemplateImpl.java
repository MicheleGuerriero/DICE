 ...
 *   <li>{@link _12.impl.TNodeTemplateImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TNodeTemplateImpl extends TEntityTemplateImpl implements TNodeTemplate {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TNODE_TEMPLATE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TNODE_TEMPLATE__NAME:
				return getName();
		}
