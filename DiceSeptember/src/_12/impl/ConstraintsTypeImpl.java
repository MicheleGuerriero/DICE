 ...
 * <ul>
 *   <li>{@link _12.impl.ConstraintsTypeImpl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintsTypeImpl extends MinimalEObjectImpl.Container implements ConstraintsType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.CONSTRAINTS_TYPE;
	}
	...
	public EList<TConstraint> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<TConstraint>(TConstraint.class, this, _12Package.CONSTRAINTS_TYPE__CONSTRAINT);
		}
		return constraint;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.CONSTRAINTS_TYPE__CONSTRAINT:
