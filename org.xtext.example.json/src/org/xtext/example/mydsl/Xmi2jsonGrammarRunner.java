...
public static void main(String[] args) throws IOException {
	...
	public static void runme(String InputModelPath, String OutputModelPath  ){
	 // Register Epackage of modeling project otherwise, you will see: make sure that Epackage is registered
		 ...
		 Injector injector = new MyjsonStandaloneSetup().createInjectorAndDoEMFRegistration();
		...
		try {
			Process p = Runtime.getRuntime().exec("python ./src/org/xtext/example/mydsl/Json2YAMLConverter.py ./"+OutputModelPath+".json"+  " ./"+OutputModelPath+".yaml");
