 ...
 * <ul>
 *   <li>{@link _12.TRelationshipTemplate#getSourceElement <em>Source Element</em>}</li>
 *   <li>{@link _12.TRelationshipTemplate#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link _12.TRelationshipTemplate#getRelationshipConstraints <em>Relationship Constraints</em>}</li>
 *   <li>{@link _12.TRelationshipTemplate#getName <em>Name</em>}</li>
 *   <li>{@link _12.TRelationshipTemplate#getUsesRelationType <em>Uses Relation Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see _12._12Package#getTRelationshipTemplate()
...
public interface TRelationshipTemplate extends TEntityTemplate {
	 ...
	 * @see _12._12Package#getTRelationshipTemplate_SourceElement()
	...
	/**
	 * Sets the value of the '{@link _12.TRelationshipTemplate#getSourceElement <em>Source Element</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see _12._12Package#getTRelationshipTemplate_TargetElement()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link _12.TRelationshipTemplate#getTargetElement <em>Target Element</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see _12._12Package#getTRelationshipTemplate_RelationshipConstraints()
	...
	/**
	 * Sets the value of the '{@link _12.TRelationshipTemplate#getRelationshipConstraints <em>Relationship Constraints</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setName(String)
	 * @see _12._12Package#getTRelationshipTemplate_Name()
	...
	/**
	 * Sets the value of the '{@link _12.TRelationshipTemplate#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Uses Relation Type</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Uses Relation Type</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Uses Relation Type</em>' containment reference.
	 * @see #setUsesRelationType(TRelationshipType)
	 * @see _12._12Package#getTRelationshipTemplate_UsesRelationType()
	 * @model containment="true"
	 * @generated
	 */
	TRelationshipType getUsesRelationType();

	/**
	 * Sets the value of the '{@link _12.TRelationshipTemplate#getUsesRelationType <em>Uses Relation Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Uses Relation Type</em>' containment reference.
	 * @see #getUsesRelationType()
	 * @generated
	 */
	void setUsesRelationType(TRelationshipType value);
