 ...
 * <ul>
 *   <li>{@link _12.impl.InputParametersTypeImpl#getInputParameter <em>Input Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputParametersTypeImpl extends MinimalEObjectImpl.Container implements InputParametersType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.INPUT_PARAMETERS_TYPE;
	}
	...
	public EList<TParameter> getInputParameter() {
		if (inputParameter == null) {
			inputParameter = new EObjectContainmentEList<TParameter>(TParameter.class, this, _12Package.INPUT_PARAMETERS_TYPE__INPUT_PARAMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.INPUT_PARAMETERS_TYPE__INPUT_PARAMETER:
