 ...
 * <ul>
 *   <li>{@link _12.impl.CapabilityDefinitionsTypeImpl#getCapabilityDefinition <em>Capability Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CapabilityDefinitionsTypeImpl extends MinimalEObjectImpl.Container implements CapabilityDefinitionsType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.CAPABILITY_DEFINITIONS_TYPE;
	}
	...
	public EList<TCapabilityDefinition> getCapabilityDefinition() {
		if (capabilityDefinition == null) {
			capabilityDefinition = new EObjectContainmentEList<TCapabilityDefinition>(TCapabilityDefinition.class, this, _12Package.CAPABILITY_DEFINITIONS_TYPE__CAPABILITY_DEFINITION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.CAPABILITY_DEFINITIONS_TYPE__CAPABILITY_DEFINITION:
