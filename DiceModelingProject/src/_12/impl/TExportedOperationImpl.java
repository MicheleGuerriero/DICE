 ...
 * <ul>
 *   <li>{@link _12.impl.TExportedOperationImpl#getNodeOperation <em>Node Operation</em>}</li>
 *   <li>{@link _12.impl.TExportedOperationImpl#getRelationshipOperation <em>Relationship Operation</em>}</li>
 *   <li>{@link _12.impl.TExportedOperationImpl#getPlan <em>Plan</em>}</li>
 *   <li>{@link _12.impl.TExportedOperationImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TExportedOperationImpl extends MinimalEObjectImpl.Container implements TExportedOperation {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TEXPORTED_OPERATION;
	}
	...
	public NotificationChain basicSetNodeOperation(NodeOperationType newNodeOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__NODE_OPERATION, oldNodeOperation, newNodeOperation);
	...
	public void setNodeOperation(NodeOperationType newNodeOperation) {
		if (newNodeOperation != nodeOperation) {
			...
			if (nodeOperation != null)
				msgs = ((InternalEObject)nodeOperation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__NODE_OPERATION, null, msgs);
			if (newNodeOperation != null)
				msgs = ((InternalEObject)newNodeOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__NODE_OPERATION, null, msgs);
			msgs = basicSetNodeOperation(newNodeOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__NODE_OPERATION, newNodeOperation, newNodeOperation));
	}
	...
	public NotificationChain basicSetRelationshipOperation(RelationshipOperationType newRelationshipOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__RELATIONSHIP_OPERATION, oldRelationshipOperation, newRelationshipOperation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRelationshipOperation(RelationshipOperationType newRelationshipOperation) {
		if (newRelationshipOperation != relationshipOperation) {
			...
			if (relationshipOperation != null)
				msgs = ((InternalEObject)relationshipOperation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__RELATIONSHIP_OPERATION, null, msgs);
			if (newRelationshipOperation != null)
				msgs = ((InternalEObject)newRelationshipOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__RELATIONSHIP_OPERATION, null, msgs);
			msgs = basicSetRelationshipOperation(newRelationshipOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__RELATIONSHIP_OPERATION, newRelationshipOperation, newRelationshipOperation));
	}
	...
	public NotificationChain basicSetPlan(PlanType newPlan, NotificationChain msgs) {
		...
		plan = newPlan;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__PLAN, oldPlan, newPlan);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPlan(PlanType newPlan) {
		if (newPlan != plan) {
			NotificationChain msgs = null;
			if (plan != null)
				msgs = ((InternalEObject)plan).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__PLAN, null, msgs);
			if (newPlan != null)
				msgs = ((InternalEObject)newPlan).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TEXPORTED_OPERATION__PLAN, null, msgs);
			msgs = basicSetPlan(newPlan, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__PLAN, newPlan, newPlan));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXPORTED_OPERATION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TEXPORTED_OPERATION__NODE_OPERATION:
				return basicSetNodeOperation(null, msgs);
			case _12Package.TEXPORTED_OPERATION__RELATIONSHIP_OPERATION:
				return basicSetRelationshipOperation(null, msgs);
			case _12Package.TEXPORTED_OPERATION__PLAN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TEXPORTED_OPERATION__PLAN:
				return getPlan();
			case _12Package.TEXPORTED_OPERATION__NAME:
				return getName();
		}
