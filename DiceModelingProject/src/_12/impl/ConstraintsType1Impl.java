 ...
 * <ul>
 *   <li>{@link _12.impl.ConstraintsType1Impl#getConstraint <em>Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintsType1Impl extends MinimalEObjectImpl.Container implements ConstraintsType1 {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.CONSTRAINTS_TYPE1;
	}
	...
	public EList<TConstraint> getConstraint() {
		if (constraint == null) {
			constraint = new EObjectContainmentEList<TConstraint>(TConstraint.class, this, _12Package.CONSTRAINTS_TYPE1__CONSTRAINT);
		}
		return constraint;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.CONSTRAINTS_TYPE1__CONSTRAINT:
