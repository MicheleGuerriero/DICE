 ...
 * <ul>
 *   <li>{@link _12.impl.TPropertyMappingImpl#getServiceTemplatePropertyRef <em>Service Template Property Ref</em>}</li>
 *   <li>{@link _12.impl.TPropertyMappingImpl#getTargetObjectRef <em>Target Object Ref</em>}</li>
 *   <li>{@link _12.impl.TPropertyMappingImpl#getTargetPropertyRef <em>Target Property Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPropertyMappingImpl extends MinimalEObjectImpl.Container implements TPropertyMapping {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TPROPERTY_MAPPING;
	}
	...
	public void setServiceTemplatePropertyRef(String newServiceTemplatePropertyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPROPERTY_MAPPING__SERVICE_TEMPLATE_PROPERTY_REF, oldServiceTemplatePropertyRef, serviceTemplatePropertyRef));
	}
	...
	public void setTargetObjectRef(String newTargetObjectRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPROPERTY_MAPPING__TARGET_OBJECT_REF, oldTargetObjectRef, targetObjectRef));
	}
	...
	public void setTargetPropertyRef(String newTargetPropertyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPROPERTY_MAPPING__TARGET_PROPERTY_REF, oldTargetPropertyRef, targetPropertyRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TPROPERTY_MAPPING__SERVICE_TEMPLATE_PROPERTY_REF:
				return getServiceTemplatePropertyRef();
			case _12Package.TPROPERTY_MAPPING__TARGET_OBJECT_REF:
				return getTargetObjectRef();
			case _12Package.TPROPERTY_MAPPING__TARGET_PROPERTY_REF:
