 ...
 * <ul>
 *   <li>{@link _12.impl.ArtifactReferencesTypeImpl#getArtifactReference <em>Artifact Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArtifactReferencesTypeImpl extends MinimalEObjectImpl.Container implements ArtifactReferencesType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.ARTIFACT_REFERENCES_TYPE;
	}
	...
	public EList<TArtifactReference> getArtifactReference() {
		if (artifactReference == null) {
			artifactReference = new EObjectContainmentEList<TArtifactReference>(TArtifactReference.class, this, _12Package.ARTIFACT_REFERENCES_TYPE__ARTIFACT_REFERENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.ARTIFACT_REFERENCES_TYPE__ARTIFACT_REFERENCE:
