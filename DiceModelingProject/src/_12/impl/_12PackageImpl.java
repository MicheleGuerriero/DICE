...
import _12.ArtifactReferencesType;
...
import _12.DerivedFromType;
import _12.DerivedFromType1;
...
import _12.MaxInstancesTypeMember1;
import _12.NodeOperationType;
import _12.NodeTypeReferenceType;
...
import _12.TEntityType;
import _12.TExportedInterface;
import _12.TExportedOperation;
import _12.TExtensibleElements;
import _12.TExtension;
import _12.TExtensions;
import _12.TImplementationArtifact;
import _12.TImplementationArtifacts;
import _12.TImport;
...
import _12.TRequiredContainerFeature;
import _12.TRequiredContainerFeatures;
...
import _12.UpperBoundTypeMember1;
import _12.UpperBoundTypeMember11;
...
import _12.util._12Validator;

import java.math.BigInteger;

import namespace.NamespacePackage;

import namespace.impl.NamespacePackageImpl;
 ...
 * @generated
 */
public class _12PackageImpl extends EPackageImpl implements _12Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EClass testDdefinitionEClass = null;
	 ...
	 * @generated
	 */
	private EClass tInputTemplateEClass = null;
	 ...
	 * @generated
	 */
	private EClass tOutputTemplateEClass = null;
	 ...
	 * @generated
	 */
	private EClass timportTemplateEClass = null;
	 ...
	 * @see _12._12Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private _12PackageImpl() {
		super(eNS_URI, _12Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link _12Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static _12Package init() {
		if (isInited) return (_12Package)EPackage.Registry.INSTANCE.getEPackage(_12Package.eNS_URI);

		// Obtain or create and register package
		_12PackageImpl the_12Package = (_12PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof _12PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new _12PackageImpl());
		...
		the_12Package.createPackageContents();
		theNamespacePackage.createPackageContents();

		// Initialize created meta-data
		the_12Package.initializePackageContents();
			...
			(the_12Package, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return _12Validator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		the_12Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(_12Package.eNS_URI, the_12Package);
		return the_12Package;
	}
	 ...
	 * @generated
	 */
	public EReference getPropertiesDefinitionType_HasSomProperties() {
	...
	public EAttribute getTProperty_DefaultValue() {
		return (EAttribute)tPropertyEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTArtifactType_MetaType() {
		return (EAttribute)tArtifactTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTEntityTemplate_Attributes() {
		return (EReference)tEntityTemplateEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTEntityTemplate_NodeHasInterface() {
		return (EReference)tEntityTemplateEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getTEntityTemplate_NodeHasRelations() {
		return (EReference)tEntityTemplateEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTNodeTemplate_Instances() {
	 ...
	 * @generated
	 */
	public EAttribute getTOperation_ScriptPath() {
		return (EAttribute)tOperationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getTRelationshipTemplate_UsesRelationType() {
		return (EReference)tRelationshipTemplateEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getTServiceTemplate_HasNodeType() {
		return (EReference)tServiceTemplateEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EReference getTServiceTemplate_HasRelationship() {
		return (EReference)tServiceTemplateEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getTServiceTemplate_HasImports() {
		return (EReference)tServiceTemplateEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EReference getTTopologyTemplate_HasInputs() {
		return (EReference)tTopologyTemplateEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getTTopologyTemplate_HasoutPuts() {
		return (EReference)tTopologyTemplateEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EClass gettestDdefinition() {
		return testDdefinitionEClass;
	}
	 ...
	 * @generated
	 */
	public EReference gettestDdefinition_Testrelation() {
		return (EReference)testDdefinitionEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getTInputTemplate() {
		return tInputTemplateEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTInputTemplate_Name() {
		return (EAttribute)tInputTemplateEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTInputTemplate_Value() {
		return (EAttribute)tInputTemplateEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTInputTemplate_Description() {
		return (EAttribute)tInputTemplateEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getTOutputTemplate() {
		return tOutputTemplateEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTOutputTemplate_Name() {
		return (EAttribute)tOutputTemplateEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTOutputTemplate_Value() {
		return (EAttribute)tOutputTemplateEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getTimportTemplate() {
		return timportTemplateEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTimportTemplate_Value() {
		return (EAttribute)timportTemplateEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public _12Factory get_12Factory() {
		return (_12Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(propertiesDefinitionTypeEClass, PROPERTIES_DEFINITION_TYPE__HAS_SOM_PROPERTIES);
		...
		createEAttribute(tPropertyEClass, TPROPERTY__DEFAULT_VALUE);
		...
		createEAttribute(tArtifactTypeEClass, TARTIFACT_TYPE__META_TYPE);
		...
		createEReference(tEntityTemplateEClass, TENTITY_TEMPLATE__ATTRIBUTES);
		createEReference(tEntityTemplateEClass, TENTITY_TEMPLATE__NODE_HAS_INTERFACE);
		createEReference(tEntityTemplateEClass, TENTITY_TEMPLATE__NODE_HAS_RELATIONS);
		...
		createEAttribute(tNodeTemplateEClass, TNODE_TEMPLATE__INSTANCES);
		...
		createEAttribute(tOperationEClass, TOPERATION__SCRIPT_PATH);
		...
		createEReference(tRelationshipTemplateEClass, TRELATIONSHIP_TEMPLATE__USES_RELATION_TYPE);
		...
		createEReference(tServiceTemplateEClass, TSERVICE_TEMPLATE__HAS_NODE_TYPE);
		createEReference(tServiceTemplateEClass, TSERVICE_TEMPLATE__HAS_RELATIONSHIP);
		createEReference(tServiceTemplateEClass, TSERVICE_TEMPLATE__HAS_IMPORTS);
		...
		createEReference(tTopologyTemplateEClass, TTOPOLOGY_TEMPLATE__HAS_INPUTS);
		createEReference(tTopologyTemplateEClass, TTOPOLOGY_TEMPLATE__HASOUT_PUTS);
		...
		testDdefinitionEClass = createEClass(TEST_DDEFINITION);
		createEReference(testDdefinitionEClass, TEST_DDEFINITION__TESTRELATION);
		...
		tInputTemplateEClass = createEClass(TINPUT_TEMPLATE);
		createEAttribute(tInputTemplateEClass, TINPUT_TEMPLATE__NAME);
		createEAttribute(tInputTemplateEClass, TINPUT_TEMPLATE__VALUE);
		createEAttribute(tInputTemplateEClass, TINPUT_TEMPLATE__DESCRIPTION);

		tOutputTemplateEClass = createEClass(TOUTPUT_TEMPLATE);
		createEAttribute(tOutputTemplateEClass, TOUTPUT_TEMPLATE__NAME);
		createEAttribute(tOutputTemplateEClass, TOUTPUT_TEMPLATE__VALUE);

		timportTemplateEClass = createEClass(TIMPORT_TEMPLATE);
		createEAttribute(timportTemplateEClass, TIMPORT_TEMPLATE__VALUE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPropertiesDefinitionType_HasSomProperties(), this.getPropertiesType(), null, "hasSomProperties", null, 0, 1, PropertiesDefinitionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTProperty_Value(), theXMLTypePackage.getString(), "value", null, 0, -1, TProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTProperty_DefaultValue(), ecorePackage.getEString(), "defaultValue", null, 0, -1, TProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTArtifactType_MetaType(), theXMLTypePackage.getString(), "MetaType", null, 0, 1, TArtifactType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTDocumentation_Lang(), theNamespacePackage.getLangType(), "lang", null, 0, 1, TDocumentation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTEntityTemplate_Type(), ecorePackage.getEString(), "type", null, 1, 1, TEntityTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTEntityTemplate_Attributes(), this.getAttributesType(), null, "attributes", null, 0, 1, TEntityTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTEntityTemplate_NodeHasInterface(), this.getTInterface(), null, "nodeHasInterface", null, 0, 1, TEntityTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTEntityTemplate_NodeHasRelations(), this.getTRelationshipType(), null, "nodeHasRelations", null, 0, -1, TEntityTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTNodeTemplate_Instances(), theXMLTypePackage.getString(), "instances", null, 0, 1, TNodeTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTOperation_ScriptPath(), ecorePackage.getEString(), "scriptPath", null, 0, 1, TOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTRelationshipTemplate_UsesRelationType(), this.getTRelationshipType(), null, "usesRelationType", null, 0, 1, TRelationshipTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTServiceTemplate_HasNodeType(), this.getTNodeType(), null, "hasNodeType", null, 0, -1, TServiceTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTServiceTemplate_HasRelationship(), this.getTRelationshipType(), null, "hasRelationship", null, 0, -1, TServiceTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTServiceTemplate_HasImports(), this.getTimportTemplate(), null, "hasImports", null, 0, 1, TServiceTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTTopologyTemplate_HasInputs(), this.getTInputTemplate(), null, "hasInputs", null, 0, -1, TTopologyTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTTopologyTemplate_HasoutPuts(), this.getTOutputTemplate(), null, "hasoutPuts", null, 0, -1, TTopologyTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(testDdefinitionEClass, testDdefinition.class, "testDdefinition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(gettestDdefinition_Testrelation(), this.getTServiceTemplate(), null, "testrelation", null, 0, -1, testDdefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tAttributeEClass, TAttribute.class, "TAttribute", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTAttribute_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, TAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAttributesType_Attribute(), this.getTAttribute(), null, "attribute", null, 1, -1, AttributesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(propertiesTypeEClass, PropertiesType.class, "PropertiesType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPropertiesType_Property(), this.getTProperty(), null, "property", null, 1, -1, PropertiesType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tInputTemplateEClass, TInputTemplate.class, "TInputTemplate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTInputTemplate_Name(), ecorePackage.getEString(), "name", null, 1, 1, TInputTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTInputTemplate_Value(), ecorePackage.getEString(), "value", null, 0, -1, TInputTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTInputTemplate_Description(), ecorePackage.getEString(), "description", null, 0, 1, TInputTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tOutputTemplateEClass, TOutputTemplate.class, "TOutputTemplate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTOutputTemplate_Name(), ecorePackage.getEString(), "name", null, 1, 1, TOutputTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTOutputTemplate_Value(), ecorePackage.getEString(), "value", null, 0, -1, TOutputTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(timportTemplateEClass, TimportTemplate.class, "TimportTemplate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTimportTemplate_Value(), ecorePackage.getEString(), "value", null, 1, -1, TimportTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		// Create annotations
		// DocumentDefinitions
		createDocumentDefinitionsAnnotations();
		// relType
		createRelTypeAnnotations();
		// http:///org/eclipse/emf/ecore/util/ExtendedMetaData
		createExtendedMetaDataAnnotations();
	}

	/**
	 * Initializes the annotations for <b>DocumentDefinitions</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createDocumentDefinitionsAnnotations() {
		String source = "DocumentDefinitions";	
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
	...
	/**
	 * Initializes the annotations for <b>relType</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createRelTypeAnnotations() {
		String source = "relType";	
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//TRelationshipType")
		   });
	}
