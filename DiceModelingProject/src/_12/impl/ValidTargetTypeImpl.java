 ...
 * <ul>
 *   <li>{@link _12.impl.ValidTargetTypeImpl#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValidTargetTypeImpl extends MinimalEObjectImpl.Container implements ValidTargetType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.VALID_TARGET_TYPE;
	}
	...
	public void setTypeRef(QName newTypeRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.VALID_TARGET_TYPE__TYPE_REF, oldTypeRef, typeRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.VALID_TARGET_TYPE__TYPE_REF:
				return getTypeRef();
		}
