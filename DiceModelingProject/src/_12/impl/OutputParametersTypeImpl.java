 ...
 * <ul>
 *   <li>{@link _12.impl.OutputParametersTypeImpl#getOutputParameter <em>Output Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutputParametersTypeImpl extends MinimalEObjectImpl.Container implements OutputParametersType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.OUTPUT_PARAMETERS_TYPE;
	}
	...
	public EList<TParameter> getOutputParameter() {
		if (outputParameter == null) {
			outputParameter = new EObjectContainmentEList<TParameter>(TParameter.class, this, _12Package.OUTPUT_PARAMETERS_TYPE__OUTPUT_PARAMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.OUTPUT_PARAMETERS_TYPE__OUTPUT_PARAMETER:
