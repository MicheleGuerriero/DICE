 ...
 * <ul>
 *   <li>{@link _12.impl.TPolicyTypeImpl#getAppliesTo <em>Applies To</em>}</li>
 *   <li>{@link _12.impl.TPolicyTypeImpl#getPolicyLanguage <em>Policy Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPolicyTypeImpl extends TEntityTypeImpl implements TPolicyType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TPOLICY_TYPE;
	}
	...
	public NotificationChain basicSetAppliesTo(TAppliesTo newAppliesTo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY_TYPE__APPLIES_TO, oldAppliesTo, newAppliesTo);
	...
	public void setAppliesTo(TAppliesTo newAppliesTo) {
		if (newAppliesTo != appliesTo) {
			...
			if (appliesTo != null)
				msgs = ((InternalEObject)appliesTo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TPOLICY_TYPE__APPLIES_TO, null, msgs);
			if (newAppliesTo != null)
				msgs = ((InternalEObject)newAppliesTo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TPOLICY_TYPE__APPLIES_TO, null, msgs);
			msgs = basicSetAppliesTo(newAppliesTo, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY_TYPE__APPLIES_TO, newAppliesTo, newAppliesTo));
	}
	...
	public void setPolicyLanguage(String newPolicyLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY_TYPE__POLICY_LANGUAGE, oldPolicyLanguage, policyLanguage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TPOLICY_TYPE__APPLIES_TO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TPOLICY_TYPE__APPLIES_TO:
				return getAppliesTo();
			case _12Package.TPOLICY_TYPE__POLICY_LANGUAGE:
