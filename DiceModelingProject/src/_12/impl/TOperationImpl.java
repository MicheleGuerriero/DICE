 ...
 *   <li>{@link _12.impl.TOperationImpl#getScriptPath <em>Script Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TOperationImpl extends TExtensibleElementsImpl implements TOperation {
	...
	public void setScriptPath(String newScriptPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TOPERATION__SCRIPT_PATH, oldScriptPath, scriptPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TOPERATION__NAME:
				return getName();
			case _12Package.TOPERATION__SCRIPT_PATH:
