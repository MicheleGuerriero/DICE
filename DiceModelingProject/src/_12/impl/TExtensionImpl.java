 ...
 * <ul>
 *   <li>{@link _12.impl.TExtensionImpl#getMustUnderstand <em>Must Understand</em>}</li>
 *   <li>{@link _12.impl.TExtensionImpl#getNamespace <em>Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TExtensionImpl extends TExtensibleElementsImpl implements TExtension {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TEXTENSION;
	}
	...
	public void setMustUnderstand(TBoolean newMustUnderstand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXTENSION__MUST_UNDERSTAND, oldMustUnderstand, mustUnderstand, !oldMustUnderstandESet));
	}
	...
	public void unsetMustUnderstand() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _12Package.TEXTENSION__MUST_UNDERSTAND, oldMustUnderstand, MUST_UNDERSTAND_EDEFAULT, oldMustUnderstandESet));
	}
	...
	public void setNamespace(String newNamespace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TEXTENSION__NAMESPACE, oldNamespace, namespace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TEXTENSION__MUST_UNDERSTAND:
				return getMustUnderstand();
			case _12Package.TEXTENSION__NAMESPACE:
				return getNamespace();
		}
