 ...
 * <ul>
 *   <li>{@link _12.impl.TRelationshipTypeImpl#getInstanceStates <em>Instance States</em>}</li>
 *   <li>{@link _12.impl.TRelationshipTypeImpl#getSourceInterfaces <em>Source Interfaces</em>}</li>
 *   <li>{@link _12.impl.TRelationshipTypeImpl#getTargetInterfaces <em>Target Interfaces</em>}</li>
 *   <li>{@link _12.impl.TRelationshipTypeImpl#getValidSource <em>Valid Source</em>}</li>
 *   <li>{@link _12.impl.TRelationshipTypeImpl#getValidTarget <em>Valid Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TRelationshipTypeImpl extends TEntityTypeImpl implements TRelationshipType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TRELATIONSHIP_TYPE;
	}
	...
	public NotificationChain basicSetInstanceStates(TTopologyElementInstanceStates newInstanceStates, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__INSTANCE_STATES, oldInstanceStates, newInstanceStates);
	...
	public void setInstanceStates(TTopologyElementInstanceStates newInstanceStates) {
		if (newInstanceStates != instanceStates) {
			...
			if (instanceStates != null)
				msgs = ((InternalEObject)instanceStates).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__INSTANCE_STATES, null, msgs);
			if (newInstanceStates != null)
				msgs = ((InternalEObject)newInstanceStates).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__INSTANCE_STATES, null, msgs);
			msgs = basicSetInstanceStates(newInstanceStates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__INSTANCE_STATES, newInstanceStates, newInstanceStates));
	}
	...
	public NotificationChain basicSetSourceInterfaces(SourceInterfacesType newSourceInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__SOURCE_INTERFACES, oldSourceInterfaces, newSourceInterfaces);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceInterfaces(SourceInterfacesType newSourceInterfaces) {
		if (newSourceInterfaces != sourceInterfaces) {
			...
			if (sourceInterfaces != null)
				msgs = ((InternalEObject)sourceInterfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__SOURCE_INTERFACES, null, msgs);
			if (newSourceInterfaces != null)
				msgs = ((InternalEObject)newSourceInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__SOURCE_INTERFACES, null, msgs);
			msgs = basicSetSourceInterfaces(newSourceInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__SOURCE_INTERFACES, newSourceInterfaces, newSourceInterfaces));
	}
	...
	public NotificationChain basicSetTargetInterfaces(TargetInterfacesType newTargetInterfaces, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__TARGET_INTERFACES, oldTargetInterfaces, newTargetInterfaces);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetInterfaces(TargetInterfacesType newTargetInterfaces) {
		if (newTargetInterfaces != targetInterfaces) {
			...
			if (targetInterfaces != null)
				msgs = ((InternalEObject)targetInterfaces).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__TARGET_INTERFACES, null, msgs);
			if (newTargetInterfaces != null)
				msgs = ((InternalEObject)newTargetInterfaces).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__TARGET_INTERFACES, null, msgs);
			msgs = basicSetTargetInterfaces(newTargetInterfaces, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__TARGET_INTERFACES, newTargetInterfaces, newTargetInterfaces));
	}
	...
	public NotificationChain basicSetValidSource(ValidSourceType newValidSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__VALID_SOURCE, oldValidSource, newValidSource);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValidSource(ValidSourceType newValidSource) {
		if (newValidSource != validSource) {
			NotificationChain msgs = null;
			if (validSource != null)
				msgs = ((InternalEObject)validSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__VALID_SOURCE, null, msgs);
			if (newValidSource != null)
				msgs = ((InternalEObject)newValidSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__VALID_SOURCE, null, msgs);
			msgs = basicSetValidSource(newValidSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__VALID_SOURCE, newValidSource, newValidSource));
	}
	...
	public NotificationChain basicSetValidTarget(ValidTargetType newValidTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__VALID_TARGET, oldValidTarget, newValidTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValidTarget(ValidTargetType newValidTarget) {
		if (newValidTarget != validTarget) {
			NotificationChain msgs = null;
			if (validTarget != null)
				msgs = ((InternalEObject)validTarget).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__VALID_TARGET, null, msgs);
			if (newValidTarget != null)
				msgs = ((InternalEObject)newValidTarget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TRELATIONSHIP_TYPE__VALID_TARGET, null, msgs);
			msgs = basicSetValidTarget(newValidTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TRELATIONSHIP_TYPE__VALID_TARGET, newValidTarget, newValidTarget));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TRELATIONSHIP_TYPE__INSTANCE_STATES:
				return basicSetInstanceStates(null, msgs);
			case _12Package.TRELATIONSHIP_TYPE__SOURCE_INTERFACES:
				return basicSetSourceInterfaces(null, msgs);
			case _12Package.TRELATIONSHIP_TYPE__TARGET_INTERFACES:
				return basicSetTargetInterfaces(null, msgs);
			case _12Package.TRELATIONSHIP_TYPE__VALID_SOURCE:
				return basicSetValidSource(null, msgs);
			case _12Package.TRELATIONSHIP_TYPE__VALID_TARGET:
