 ...
 * <ul>
 *   <li>{@link _12.impl.TPolicyImpl#getName <em>Name</em>}</li>
 *   <li>{@link _12.impl.TPolicyImpl#getPolicyRef <em>Policy Ref</em>}</li>
 *   <li>{@link _12.impl.TPolicyImpl#getPolicyType <em>Policy Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TPolicyImpl extends TExtensibleElementsImpl implements TPolicy {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TPOLICY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY__NAME, oldName, name));
	}
	...
	public void setPolicyRef(QName newPolicyRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY__POLICY_REF, oldPolicyRef, policyRef));
	}
	...
	public void setPolicyType(QName newPolicyType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TPOLICY__POLICY_TYPE, oldPolicyType, policyType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TPOLICY__NAME:
				return getName();
			case _12Package.TPOLICY__POLICY_REF:
				return getPolicyRef();
			case _12Package.TPOLICY__POLICY_TYPE:
