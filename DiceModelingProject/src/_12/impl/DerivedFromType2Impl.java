 ...
 * <ul>
 *   <li>{@link _12.impl.DerivedFromType2Impl#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DerivedFromType2Impl extends MinimalEObjectImpl.Container implements DerivedFromType2 {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.DERIVED_FROM_TYPE2;
	}
	...
	public void setTypeRef(QName newTypeRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.DERIVED_FROM_TYPE2__TYPE_REF, oldTypeRef, typeRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.DERIVED_FROM_TYPE2__TYPE_REF:
				return getTypeRef();
		}
