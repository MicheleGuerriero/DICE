 ...
 * <ul>
 *   <li>{@link _12.impl.ValidSourceTypeImpl#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValidSourceTypeImpl extends MinimalEObjectImpl.Container implements ValidSourceType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.VALID_SOURCE_TYPE;
	}
	...
	public void setTypeRef(QName newTypeRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.VALID_SOURCE_TYPE__TYPE_REF, oldTypeRef, typeRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.VALID_SOURCE_TYPE__TYPE_REF:
				return getTypeRef();
		}
