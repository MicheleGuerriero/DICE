 ...
 * <ul>
 *   <li>{@link _12.impl.TTopologyElementInstanceStatesImpl#getInstanceState <em>Instance State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TTopologyElementInstanceStatesImpl extends MinimalEObjectImpl.Container implements TTopologyElementInstanceStates {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TTOPOLOGY_ELEMENT_INSTANCE_STATES;
	}
	...
	public EList<InstanceStateType> getInstanceState() {
		if (instanceState == null) {
			instanceState = new EObjectContainmentEList<InstanceStateType>(InstanceStateType.class, this, _12Package.TTOPOLOGY_ELEMENT_INSTANCE_STATES__INSTANCE_STATE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TTOPOLOGY_ELEMENT_INSTANCE_STATES__INSTANCE_STATE:
