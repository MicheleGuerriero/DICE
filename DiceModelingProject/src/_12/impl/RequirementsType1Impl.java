 ...
 * <ul>
 *   <li>{@link _12.impl.RequirementsType1Impl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequirementsType1Impl extends MinimalEObjectImpl.Container implements RequirementsType1 {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.REQUIREMENTS_TYPE1;
	}
	...
	public EList<TRequirementRef> getRequirement() {
		if (requirement == null) {
			requirement = new EObjectContainmentEList<TRequirementRef>(TRequirementRef.class, this, _12Package.REQUIREMENTS_TYPE1__REQUIREMENT);
		}
		return requirement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.REQUIREMENTS_TYPE1__REQUIREMENT:
