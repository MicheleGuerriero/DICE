 ...
 * @generated
 */
public class _12Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case _12Package.TEST_DDEFINITION: {
				testDdefinition testDdefinition = (testDdefinition)theEObject;
				T result = casetestDdefinition(testDdefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case _12Package.TINPUT_TEMPLATE: {
				TInputTemplate tInputTemplate = (TInputTemplate)theEObject;
				T result = caseTInputTemplate(tInputTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case _12Package.TOUTPUT_TEMPLATE: {
				TOutputTemplate tOutputTemplate = (TOutputTemplate)theEObject;
				T result = caseTOutputTemplate(tOutputTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case _12Package.TIMPORT_TEMPLATE: {
				TimportTemplate timportTemplate = (TimportTemplate)theEObject;
				T result = caseTimportTemplate(timportTemplate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>test Ddefinition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>test Ddefinition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casetestDdefinition(testDdefinition object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TInput Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>TInput Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTInputTemplate(TInputTemplate object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>TOutput Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>TOutput Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTOutputTemplate(TOutputTemplate object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Timport Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Timport Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTimportTemplate(TimportTemplate object) {
		return null;
	}
