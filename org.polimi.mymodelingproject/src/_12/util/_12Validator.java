 ...
 * @generated
 */
public class _12Validator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final _12Validator INSTANCE = new _12Validator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "_12";
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
		switch (classifierID) {
			case _12Package.ARTIFACT_REFERENCES_TYPE:
			...
			case _12Package.NODE_TYPE_REFERENCE_TYPE:
			...
			case _12Package.TCAPABILITY_TYPE:
			...
			case _12Package.TNODE_TYPE_IMPLEMENTATION:
			...
			case _12Package.TREQUIREMENT_TYPE:
			...
			case _12Package.TEST_DDEFINITION:
				return validatetestDdefinition((testDdefinition)value, diagnostics, context);
			case _12Package.TATTRIBUTE:
				return validateTAttribute((TAttribute)value, diagnostics, context);
			...
			case _12Package.TINPUT_TEMPLATE:
				return validateTInputTemplate((TInputTemplate)value, diagnostics, context);
			case _12Package.TOUTPUT_TEMPLATE:
				return validateTOutputTemplate((TOutputTemplate)value, diagnostics, context);
			case _12Package.TIMPORT_TEMPLATE:
				return validateTimportTemplate((TimportTemplate)value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validatetestDdefinition(testDdefinition testDdefinition, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(testDdefinition, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateTAttribute(TAttribute tAttribute, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(tAttribute, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateTInputTemplate(TInputTemplate tInputTemplate, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(tInputTemplate, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateTOutputTemplate(TOutputTemplate tOutputTemplate, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(tOutputTemplate, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public boolean validateTimportTemplate(TimportTemplate timportTemplate, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(timportTemplate, diagnostics, context);
	}
	...
	public boolean validateMaxInstancesType_MemberTypes(Object maxInstancesType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			...
			if (_12Package.Literals.MAX_INSTANCES_TYPE_MEMBER0.isInstance(maxInstancesType)) {
				if (validateMaxInstancesTypeMember0((BigInteger)maxInstancesType, tempDiagnostics, context)) return true;
			}
			if (_12Package.Literals.MAX_INSTANCES_TYPE_MEMBER1.isInstance(maxInstancesType)) {
	...
	public boolean validateMaxInstancesTypeMember0_Pattern(BigInteger maxInstancesTypeMember0, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(_12Package.Literals.MAX_INSTANCES_TYPE_MEMBER0, maxInstancesTypeMember0, MAX_INSTANCES_TYPE_MEMBER0__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateUpperBoundType_MemberTypes(Object upperBoundType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (_12Package.Literals.UPPER_BOUND_TYPE_MEMBER0.isInstance(upperBoundType)) {
				if (validateUpperBoundTypeMember0((BigInteger)upperBoundType, tempDiagnostics, context)) return true;
			}
			if (_12Package.Literals.UPPER_BOUND_TYPE_MEMBER1.isInstance(upperBoundType)) {
	...
	public boolean validateUpperBoundType1_MemberTypes(Object upperBoundType1, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (diagnostics != null) {
			BasicDiagnostic tempDiagnostics = new BasicDiagnostic();
			if (_12Package.Literals.UPPER_BOUND_TYPE_MEMBER01.isInstance(upperBoundType1)) {
				if (validateUpperBoundTypeMember01((BigInteger)upperBoundType1, tempDiagnostics, context)) return true;
			}
			if (_12Package.Literals.UPPER_BOUND_TYPE_MEMBER11.isInstance(upperBoundType1)) {
	...
	public boolean validateUpperBoundTypeMember0_Pattern(BigInteger upperBoundTypeMember0, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(_12Package.Literals.UPPER_BOUND_TYPE_MEMBER0, upperBoundTypeMember0, UPPER_BOUND_TYPE_MEMBER0__PATTERN__VALUES, diagnostics, context);
	}
	...
	public boolean validateUpperBoundTypeMember01_Pattern(BigInteger upperBoundTypeMember01, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validatePattern(_12Package.Literals.UPPER_BOUND_TYPE_MEMBER01, upperBoundTypeMember01, UPPER_BOUND_TYPE_MEMBER01__PATTERN__VALUES, diagnostics, context);
	}
