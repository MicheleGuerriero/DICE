 ...
 * <ul>
 *   <li>{@link _12.impl.PoliciesTypeImpl#getPolicy <em>Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PoliciesTypeImpl extends MinimalEObjectImpl.Container implements PoliciesType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.POLICIES_TYPE;
	}
	...
	public EList<TPolicy> getPolicy() {
		if (policy == null) {
			policy = new EObjectContainmentEList<TPolicy>(TPolicy.class, this, _12Package.POLICIES_TYPE__POLICY);
		}
		return policy;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.POLICIES_TYPE__POLICY:
