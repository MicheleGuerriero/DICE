 ...
 * <ul>
 *   <li>{@link _12.impl.TDeploymentArtifactImpl#getArtifactRef <em>Artifact Ref</em>}</li>
 *   <li>{@link _12.impl.TDeploymentArtifactImpl#getArtifactType <em>Artifact Type</em>}</li>
 *   <li>{@link _12.impl.TDeploymentArtifactImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TDeploymentArtifactImpl extends TExtensibleElementsImpl implements TDeploymentArtifact {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TDEPLOYMENT_ARTIFACT;
	}
	...
	public void setArtifactRef(QName newArtifactRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TDEPLOYMENT_ARTIFACT__ARTIFACT_REF, oldArtifactRef, artifactRef));
	}
	...
	public void setArtifactType(QName newArtifactType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TDEPLOYMENT_ARTIFACT__ARTIFACT_TYPE, oldArtifactType, artifactType));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TDEPLOYMENT_ARTIFACT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.TDEPLOYMENT_ARTIFACT__ARTIFACT_REF:
				return getArtifactRef();
			case _12Package.TDEPLOYMENT_ARTIFACT__ARTIFACT_TYPE:
				return getArtifactType();
			case _12Package.TDEPLOYMENT_ARTIFACT__NAME:
				return getName();
		}
