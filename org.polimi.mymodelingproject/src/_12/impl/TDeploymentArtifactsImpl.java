 ...
 * <ul>
 *   <li>{@link _12.impl.TDeploymentArtifactsImpl#getDeploymentArtifact <em>Deployment Artifact</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TDeploymentArtifactsImpl extends MinimalEObjectImpl.Container implements TDeploymentArtifacts {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TDEPLOYMENT_ARTIFACTS;
	}
	...
	public EList<TDeploymentArtifact> getDeploymentArtifact() {
		if (deploymentArtifact == null) {
			deploymentArtifact = new EObjectContainmentEList<TDeploymentArtifact>(TDeploymentArtifact.class, this, _12Package.TDEPLOYMENT_ARTIFACTS__DEPLOYMENT_ARTIFACT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TDEPLOYMENT_ARTIFACTS__DEPLOYMENT_ARTIFACT:
