 ...
 * <ul>
 *   <li>{@link _12.impl.TArtifactTemplateImpl#getArtifactReferences <em>Artifact References</em>}</li>
 *   <li>{@link _12.impl.TArtifactTemplateImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TArtifactTemplateImpl extends TEntityTemplateImpl implements TArtifactTemplate {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TARTIFACT_TEMPLATE;
	}
	...
	public NotificationChain basicSetArtifactReferences(ArtifactReferencesType newArtifactReferences, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TARTIFACT_TEMPLATE__ARTIFACT_REFERENCES, oldArtifactReferences, newArtifactReferences);
	...
	public void setArtifactReferences(ArtifactReferencesType newArtifactReferences) {
		if (newArtifactReferences != artifactReferences) {
			...
			if (artifactReferences != null)
				msgs = ((InternalEObject)artifactReferences).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TARTIFACT_TEMPLATE__ARTIFACT_REFERENCES, null, msgs);
			if (newArtifactReferences != null)
				msgs = ((InternalEObject)newArtifactReferences).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TARTIFACT_TEMPLATE__ARTIFACT_REFERENCES, null, msgs);
			msgs = basicSetArtifactReferences(newArtifactReferences, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TARTIFACT_TEMPLATE__ARTIFACT_REFERENCES, newArtifactReferences, newArtifactReferences));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TARTIFACT_TEMPLATE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TARTIFACT_TEMPLATE__ARTIFACT_REFERENCES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TARTIFACT_TEMPLATE__NAME:
				return getName();
		}
