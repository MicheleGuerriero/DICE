 ...
 * <ul>
 *   <li>{@link _12.impl.TAppliesToImpl#getNodeTypeReference <em>Node Type Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TAppliesToImpl extends MinimalEObjectImpl.Container implements TAppliesTo {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TAPPLIES_TO;
	}
	...
	public EList<NodeTypeReferenceType> getNodeTypeReference() {
		if (nodeTypeReference == null) {
			nodeTypeReference = new EObjectContainmentEList<NodeTypeReferenceType>(NodeTypeReferenceType.class, this, _12Package.TAPPLIES_TO__NODE_TYPE_REFERENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TAPPLIES_TO__NODE_TYPE_REFERENCE:
