 ...
 * <ul>
 *   <li>{@link _12.impl.TConstraintImpl#getAny <em>Any</em>}</li>
 *   <li>{@link _12.impl.TConstraintImpl#getConstraintType <em>Constraint Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TConstraintImpl extends MinimalEObjectImpl.Container implements TConstraint {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TCONSTRAINT;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _12Package.TCONSTRAINT__ANY);
		}
		return any;
	}
	...
	public void setConstraintType(String newConstraintType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TCONSTRAINT__CONSTRAINT_TYPE, oldConstraintType, constraintType));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TCONSTRAINT__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TCONSTRAINT__CONSTRAINT_TYPE:
