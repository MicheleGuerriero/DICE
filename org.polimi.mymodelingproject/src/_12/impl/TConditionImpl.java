 ...
 * <ul>
 *   <li>{@link _12.impl.TConditionImpl#getAny <em>Any</em>}</li>
 *   <li>{@link _12.impl.TConditionImpl#getExpressionLanguage <em>Expression Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TConditionImpl extends MinimalEObjectImpl.Container implements TCondition {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TCONDITION;
	}
	...
	public FeatureMap getAny() {
		if (any == null) {
			any = new BasicFeatureMap(this, _12Package.TCONDITION__ANY);
		}
		return any;
	}
	...
	public void setExpressionLanguage(String newExpressionLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TCONDITION__EXPRESSION_LANGUAGE, oldExpressionLanguage, expressionLanguage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TCONDITION__ANY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TCONDITION__EXPRESSION_LANGUAGE:
