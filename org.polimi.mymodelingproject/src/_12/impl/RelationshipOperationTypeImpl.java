 ...
 * <ul>
 *   <li>{@link _12.impl.RelationshipOperationTypeImpl#getInterfaceName <em>Interface Name</em>}</li>
 *   <li>{@link _12.impl.RelationshipOperationTypeImpl#getOperationName <em>Operation Name</em>}</li>
 *   <li>{@link _12.impl.RelationshipOperationTypeImpl#getRelationshipRef <em>Relationship Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationshipOperationTypeImpl extends MinimalEObjectImpl.Container implements RelationshipOperationType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.RELATIONSHIP_OPERATION_TYPE;
	}
	...
	public void setInterfaceName(String newInterfaceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.RELATIONSHIP_OPERATION_TYPE__INTERFACE_NAME, oldInterfaceName, interfaceName));
	}
	...
	public void setOperationName(String newOperationName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.RELATIONSHIP_OPERATION_TYPE__OPERATION_NAME, oldOperationName, operationName));
	}
	...
	public void setRelationshipRef(String newRelationshipRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.RELATIONSHIP_OPERATION_TYPE__RELATIONSHIP_REF, oldRelationshipRef, relationshipRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.RELATIONSHIP_OPERATION_TYPE__INTERFACE_NAME:
				return getInterfaceName();
			case _12Package.RELATIONSHIP_OPERATION_TYPE__OPERATION_NAME:
				return getOperationName();
			case _12Package.RELATIONSHIP_OPERATION_TYPE__RELATIONSHIP_REF:
