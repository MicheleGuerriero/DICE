 ...
 * <ul>
 *   <li>{@link _12.impl.TExtensionsImpl#getExtension <em>Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TExtensionsImpl extends TExtensibleElementsImpl implements TExtensions {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TEXTENSIONS;
	}
	...
	public EList<TExtension> getExtension() {
		if (extension == null) {
			extension = new EObjectContainmentEList<TExtension>(TExtension.class, this, _12Package.TEXTENSIONS__EXTENSION);
		}
		return extension;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TEXTENSIONS__EXTENSION:
