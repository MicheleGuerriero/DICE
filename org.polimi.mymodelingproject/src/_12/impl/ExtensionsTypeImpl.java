 ...
 * <ul>
 *   <li>{@link _12.impl.ExtensionsTypeImpl#getExtension <em>Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionsTypeImpl extends MinimalEObjectImpl.Container implements ExtensionsType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.EXTENSIONS_TYPE;
	}
	...
	public EList<TExtension> getExtension() {
		if (extension == null) {
			extension = new EObjectContainmentEList<TExtension>(TExtension.class, this, _12Package.EXTENSIONS_TYPE__EXTENSION);
		}
		return extension;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.EXTENSIONS_TYPE__EXTENSION:
