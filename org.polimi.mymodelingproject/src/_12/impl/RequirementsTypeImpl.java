 ...
 * <ul>
 *   <li>{@link _12.impl.RequirementsTypeImpl#getRequirement <em>Requirement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequirementsTypeImpl extends MinimalEObjectImpl.Container implements RequirementsType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.REQUIREMENTS_TYPE;
	}
	...
	public EList<TRequirement> getRequirement() {
		if (requirement == null) {
			requirement = new EObjectContainmentEList<TRequirement>(TRequirement.class, this, _12Package.REQUIREMENTS_TYPE__REQUIREMENT);
		}
		return requirement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.REQUIREMENTS_TYPE__REQUIREMENT:
