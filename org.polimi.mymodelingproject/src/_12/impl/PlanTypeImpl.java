 ...
 * <ul>
 *   <li>{@link _12.impl.PlanTypeImpl#getPlanRef <em>Plan Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlanTypeImpl extends MinimalEObjectImpl.Container implements PlanType {
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.PLAN_TYPE;
	}
	...
	public void setPlanRef(String newPlanRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.PLAN_TYPE__PLAN_REF, oldPlanRef, planRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _12Package.PLAN_TYPE__PLAN_REF:
				return getPlanRef();
		}
