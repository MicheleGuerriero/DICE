 ...
 * <ul>
 *   <li>{@link _12.impl.TRequirementDefinitionImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link _12.impl.TRequirementDefinitionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link _12.impl.TRequirementDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link _12.impl.TRequirementDefinitionImpl#getRequirementType <em>Requirement Type</em>}</li>
 *   <li>{@link _12.impl.TRequirementDefinitionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TRequirementDefinitionImpl extends TExtensibleElementsImpl implements TRequirementDefinition {
	 ...
	 * @ordered
	 */
	protected static final Object UPPER_BOUND_EDEFAULT = _12Factory.eINSTANCE.createFromString(_12Package.eINSTANCE.getUpperBoundType1(), "1");
	...
	protected EClass eStaticClass() {
		return _12Package.Literals.TREQUIREMENT_DEFINITION;
	}
	...
	public NotificationChain basicSetConstraints(ConstraintsType1 newConstraints, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__CONSTRAINTS, oldConstraints, newConstraints);
	...
	public void setConstraints(ConstraintsType1 newConstraints) {
		if (newConstraints != constraints) {
			...
			if (constraints != null)
				msgs = ((InternalEObject)constraints).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - _12Package.TREQUIREMENT_DEFINITION__CONSTRAINTS, null, msgs);
			if (newConstraints != null)
				msgs = ((InternalEObject)newConstraints).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - _12Package.TREQUIREMENT_DEFINITION__CONSTRAINTS, null, msgs);
			msgs = basicSetConstraints(newConstraints, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__CONSTRAINTS, newConstraints, newConstraints));
	}
	...
	public void setLowerBound(int newLowerBound) {
		...
		lowerBoundESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__LOWER_BOUND, oldLowerBound, lowerBound, !oldLowerBoundESet));
	}
	...
	public void unsetLowerBound() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _12Package.TREQUIREMENT_DEFINITION__LOWER_BOUND, oldLowerBound, LOWER_BOUND_EDEFAULT, oldLowerBoundESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__NAME, oldName, name));
	}
	...
	public void setRequirementType(QName newRequirementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__REQUIREMENT_TYPE, oldRequirementType, requirementType));
	}
	...
	public void setUpperBound(Object newUpperBound) {
		...
		upperBoundESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _12Package.TREQUIREMENT_DEFINITION__UPPER_BOUND, oldUpperBound, upperBound, !oldUpperBoundESet));
	}
	...
	public void unsetUpperBound() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _12Package.TREQUIREMENT_DEFINITION__UPPER_BOUND, oldUpperBound, UPPER_BOUND_EDEFAULT, oldUpperBoundESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _12Package.TREQUIREMENT_DEFINITION__CONSTRAINTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _12Package.TREQUIREMENT_DEFINITION__LOWER_BOUND:
				return getLowerBound();
			case _12Package.TREQUIREMENT_DEFINITION__NAME:
				return getName();
			case _12Package.TREQUIREMENT_DEFINITION__REQUIREMENT_TYPE:
				return getRequirementType();
			case _12Package.TREQUIREMENT_DEFINITION__UPPER_BOUND:
