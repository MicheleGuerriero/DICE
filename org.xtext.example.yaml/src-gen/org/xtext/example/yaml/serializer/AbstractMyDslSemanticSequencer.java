...
public abstract class AbstractMyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_DerivedFromType2(EObject context, DerivedFromType2 semanticObject) {
		...
		feeder.accept(grammarAccess.getDerivedFromType2Access().getTypeRefQNameParserRuleCall_0(), semanticObject.getTypeRef());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (name=EString (value+=EString value+=EString*)? description=EString?)
	 */
	...
	/**
	 * Constraint:
	 *     (name=String0 (value+=String0 value+=String0*)? (defaultValue+=EString defaultValue+=EString*)?)
	 */
